    ...
    public void init(String s) {
        try {
            ...
            for (int i = 0; i < nodes.length(); i++)
            {
                ...
                nodeData ni = new nodeData(point,id,0.0,null,0);
                this.addNode(ni);
...
//        return MC == dGraph.MC &&
//                edgesSize == dGraph.edgesSize &&
//                _robots_number == dGraph._robots_number &&
//                _fruits_number == dGraph._fruits_number &&
//                vertices.equals(dGraph.vertices) &&
//                edges.equals(dGraph.edges) &&
//                data.equals(dGraph.data);
//    }
